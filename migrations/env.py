...
config.set_section_option(section, "DB_USER", "ultrasonics")
config.set_section_option(section, "DB_PASSWORD", "ultrasonics2025G%%")  # Using escaped password for config parser
...
from ultrasonics.models import Base
